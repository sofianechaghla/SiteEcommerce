...
<div class="container-fluid">
  <div class="row">
    ...
    <?php include "./templates/sidebar.php"; ?>
      ...
      <div class="row">
      	<div class="col-10">
      		<h2>Gérer la catégorie</h2>
      	</div>
      	<div class="col-2">
      		<a href="#" data-toggle="modal" data-target="#add_category_modal" class="btn btn-warning btn-sm">ajoutez Article par Categories</a>
      	</div>
      </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Mettre à jour la catégorie</h5>
      ...
      <div class="modal-body">
        <form id="add-category-form" enctype="multipart/form-data">
        	<div class="row">
        		...
        		<div class="col-12">
        			<button type="button" class="btn btn-primary add-category">ajouter une catégorie</button>
        		</div>
        	</div>
      ...
      <div class="modal-body">
        <form id="edit-category-form" enctype="multipart/form-data">
          <div class="row">
            ...
            <div class="col-12">
              <button type="button" class="btn btn-primary edit-category-btn">Mettre à jour la catégorie</button>
            </div>
          </div>
